const authMiddleware = require('../backend/middleware/auth.js'); // ✅ Adjust the path if different
const express = require('express');
const cors = require('cors');
const mongoose = require('mongoose');
const dotenv = require('dotenv');
const axios = require('axios');
const verifyToken = require('../backend/middleware/auth.js');
const bcrypt = require('bcryptjs');
const nodemailer = require('nodemailer');
const jwt = require('jsonwebtoken');
const sendEmail = require('../backend/utils/sendEmail.js'); // update path as per your folder structure
const Consultant = require('../backend/models/Consultant.js');
const ApiKey = require('../backend/models/ApiKey.js'); // adjust the path if needed
const fs = require('fs');
const path = require('path');
const Booking = require('../backend/models/Booking.js');
